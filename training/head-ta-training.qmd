...
-   Office hours are posted in the departmental office hours master list
...
-   Sending personal reminders to TAs who have no completed grading by the deadline.
...
-   Spot check the grading accuracy and quality of written feedback, and let TAs know if they need to improve either

-   Let the instructor know that grades are ready for release or if there are any outstanding questions about grading

-   If requested, do a first pass on regrade requests.

. . .

*This will be the focus of the next check-in meeting.*
