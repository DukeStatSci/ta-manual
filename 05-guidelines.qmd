...
-   Please avoid *"didactic dictation"*.
    ...
    (Use .Rmd files for that instead.) Live coding, where you are demonstrating something as you talk about it, and students code along, should be done slowly.
...
-   Grade by question, i.e., grade all of question 1, then all of question 2,... This will facilitate greater consistency.
