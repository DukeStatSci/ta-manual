...
- Grade by question, i.e., grade all of question 1, then all of question 2,… This will facilitate greater consistency. You may be assigned only one or a few questions from an entire assignment, especially if you are using Gradescope. 
...
- Many courses use _positive grading_ in the department. For each problem, clearly mark the number of points earned and the number of points possible. Gradescope or Sakai will do the tallying for you.
