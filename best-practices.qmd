...
-   **Books:** Many courses now have electronic versions of the text available for free online or through the Duke Libraries.
    Please check with your instructor first. You should never have to buy your own text for TAing. 
...
-   **Course website:** Familiarize yourself with the website and Canvas site for the course.
    Canvas is a university wide course development and presentation platform known as a Learning Management System (LMS) that replaced Sakai in 2024.
    All courses use Canvas at least for grades.
    You will need a NetID to access Canvas at <https://canvas.duke.edu>.
    ...
    Canvas will also allow you to send emails to individuals or groups, host online discussions, collect homework assignments, and allow students to view their grades.
    Canvas may also be used to organize Zoom meetings for the course lectures, labs, and office hours.
    ...
    Your required TA training may include Canvas training as well.
    Note that undergraduate TAs are not supposed to have access to the full gradebook in Canvas; however, you may be able to do anonymous grading.
    If you have problems with the LMS, let your instructor know.
...
-   **Discussion tools:** Piazza is no longer supported by Duke University but individual instructors may still choose to use it.
    Alternative Q&A or discussion tools include Discussions or Ed Discussions in Canvas and and other tools your instructors may choose.
    Once your instructor has chosen which tool they will use, ask for training on that tool.

-   **Gradescope:** Gradescope is an online grading tool that is usually integrated with Canvas.
    ...
    You will access Gradescope using your NetID similarly to accessing  Canvas. You can also access it from within Canvas. 
    ...
    Course-specific Gradescope training will be offered if needed.
...
-   Many instructors will set up Zoom office hours rooms via Canvas.
    Practices may differ between instructors but it is a good idea to set up a Google sheet that stays linked in Canvas that can be used for students to indicate their question or need during the session if online.
...
-   Avoid solving homework problems for students. 
    ...
    Never tell students that their work is correct; this will lead to problems if you are wrong.
...
-   Set grading policies for partial credit, late papers, etc. with the instructor.
    Make sure these policies are easily accessible by students (e.g., on Canvas, or the course website).
...
-   Grading turnaround deadlines will be set by the instructor. 
    ...
    If an emergency or illness will prevent timely grading completion, inform the instructor as soon as you can.
